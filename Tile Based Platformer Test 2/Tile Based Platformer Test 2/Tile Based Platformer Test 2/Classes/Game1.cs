...
namespace Tile_Based_Platformer_Test_2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            ...
            this.Window.Title = "Tile Engine V1"; //window title
        }
        ...
        protected override void LoadContent()
        {
            ...
            Current_Level.LoadFile("Content/Maps/Chris game.txt", Content);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.BackToFront, BlendState.AlphaBlend);
                Current_Level.Y_Axis = 0;
                Current_Level.X_Axis = 0;
                Player1.Draw(spriteBatch, Content);
                Current_Level.Draw(spriteBatch, Content);
